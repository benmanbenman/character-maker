...
var app = (function () {
    ...
    /* src/components/Tabs.svelte generated by Svelte v3.43.0 */
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 13, 12, 290);
    			attr_dev(li, "class", "svelte-1ts68i2");
    			add_location(li, file$1, 12, 9, 228);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$1, 10, 3, 186);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "nwe test";
    			add_location(p, file, 16, 6, 358);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(14:3) {#if activeItem === 'stats'}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*activeItem*/ ctx[0] === 'stats') return create_if_block;
    		if (/*activeItem*/ ctx[0] === 'details') return create_if_block_1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 11, 0, 199);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Tabs, items, activeItem, tabChange });
