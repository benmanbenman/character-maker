...
var app = (function () {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 13, 12, 290);
    			attr_dev(li, "class", "svelte-1ts68i2");
    			add_location(li, file$2, 12, 9, 228);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$2, 10, 3, 186);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$1, 23, 6, 570);
    			add_location(br, file$1, 24, 6, 613);
    		},
    		m: function mount(target, anchor) {
    ...
    class Select extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { arr: 1, value: 0, storage: 3, prop: 4 });
